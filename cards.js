...
document.getElementById("open-card-btn-planetas").addEventListener("click", function(event) {
...
document.getElementById("open-card-btn-astros").addEventListener("click", function(event) {
    event.stopPropagation(); // Evita que el clic en el botón cierre la tarjeta
